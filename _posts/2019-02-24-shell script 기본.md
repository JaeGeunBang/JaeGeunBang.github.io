...
### 숫자 계산
모든 변수의 값은 문자열로 취급하기 때문에, 숫자 연산 (+, -, *, /) 를 하기 위해 `expr` 키워드를 사용한다. <br>
추가로 곱하기 (*)랑 괄호는 앞에 \ 값을 붙여줘야 한다. <br>
...
>
> while read line ; do
> > read는 위에서 읽은 topology.data의 한 row를 읽어 line에 저장한다. <br>
